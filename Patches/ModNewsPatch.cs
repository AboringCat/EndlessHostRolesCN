...
public class ModNews
{
    ...
    public ModNews(int NewsNumber, string NewsTitle, string NewsSubTitle, string NewsShortTitle, string NewsText, string NewsDate)
    {
    ...
    public static void Initialize_Postfix(ref Il2CppSystem.Collections.IEnumerator __result)
    {
        static IEnumerator FetchBlacklist()
        {
            ...
            {
                var Newsnumber = int.Parse(newsElement.GetProperty("Number").GetString());
                var Newstitle = newsElement.GetProperty("Title").GetString();
                var NewssubTitle = newsElement.GetProperty("Subtitle").GetString();
                var NewsshortTitle = newsElement.GetProperty("Short").GetString();
    ...
    public static void SetUpPanel_Postfix(AnnouncementPanel __instance, [HarmonyArgument(0)] Announcement announcement)
    {
        ...
        renderer.sprite = Utils.LoadSprite($"EHR-Icon.png", 250f);
